                      ...
                      <div className="product p-4"> 
                        <div className="mt-4 mb-3"> <span className="text-uppercase text-muted brand">Orianz</span>
                          ...
                          <div className="sizes mt-5">
                            <h6 className="text-uppercase">Size</h6> <label className={"radio " + styles[`size-button`]}> <input type="radio" name="size" value="S" onChange={() => onChange("S")} defaultChecked/> <span>S</span> </label> <label className={"radio " + styles[`size-button`]}> <input type="radio" name="size" value="M" onChange={() => onChange("M")}/> <span>M</span> </label> <label className={"radio " + styles[`size-button`]}> <input type="radio" name="size" value="L" onChange={() => onChange("L")}/> <span>L</span> </label> <label className={"radio " + styles[`size-button`]}> <input type="radio" name="size" value="XL" onChange={() => onChange("XL")}/> <span>XL</span> </label> <label className={"radio " + styles[`size-button`]}> <input type="radio" name="size" value="XXL" onChange={() => onChange("XXL")}/> <span>XXL</span> </label>
                          </div>
