...
// 2020 Team Images
import Jelinna_Image from "public/img/exec/2020/Jelinna.jpg";
import Roary_Image from "public/img/exec/2020/Roary.jpg";
import Shrey_Image from "public/img/exec/2020/Shrey.jpg";
import Xavier_Image from "public/img/exec/2020/Xavier.jpg";
import Ian_Image from "public/img/exec/2020/Ian.png";
import Stanley_Image from "public/img/exec/2020/Stanley.jpeg";
import Hayes_Image from "public/img/exec/2020/Hayes.jpeg";
import Emily20_Image from "public/img/exec/2020/Emily.png";
import Lelland_Image from "public/img/exec/2020/Lelland.jpeg";
import Susan_Image from "public/img/exec/2020/Susan.jpg";
import Vincent_Image from "public/img/exec/2020/Vincent.jpg";

// 2021 Team Images
import Kenuka_Image from "public/img/exec/2021/Kenuka.jpg";
import Celine_Image from "public/img/exec/2021/Celine.jpg";
import Kai_Image from "public/img/exec/2021/Kai.jpeg";
import Connor_Image from "public/img/exec/2021/Connor.jpg";
import Micah_Image from "public/img/exec/2021/Micah.jpg";
import Jasmin_Image from "public/img/exec/2021/Jasmin.jpeg";
import Hirun_Image from "public/img/exec/2021/Hirun.jpeg";
import Keshmira_Image from "public/img/exec/2021/Keshmira.jpg";
import Claire_Image from "public/img/exec/2021/Claire.jpg";
import Jack_Image from "public/img/exec/2021/Jack.jpg";
import Noa_Image from "public/img/exec/2021/Noa.jpg";

// 2022 Team Images
import Miah_Image from "public/img/exec/2022/Miah.jpg";
import Ronaldo_Image from "public/img/exec/2022/Ronaldo.jpg";
import Nala_Image from "public/img/exec/2022/Nala.jpg";
import Vivian_Image from "public/img/exec/2022/Vivian.jpg";
import Cameron_Image from "public/img/exec/2022/Cameron.jpg";
import Jess_Image from "public/img/exec/2022/Jess.jpg";
import Alannah_Image from "public/img/exec/2022/Alannah.png";
import Tiana_Image from "public/img/exec/2022/Tiana.png";
import Emily22_Image from "public/img/exec/2022/Emily.jpg";
...
import Angelo_Image_2025 from "public/img/exec/2025/Angelo.png"; 
import Niamh_Image_2025 from "public/img/exec/2025/Nimah.png"; 
    ...
    subcoms: [
      {
        ...
        members: ["Hayley Gayfer", "Claire Xue", "Piper Workman"],
      },
      {
        icons: [faUserFriends],
        name: "Social",
        ...
        members: ["Noa Challis", "Felicity Chan", "Jasmin Oren"],
      },
      {
        icons: [faDove],
        name: "Charity",
        ...
        members: ["Hirun Bandara", "Jack Yin", "Keshmira Vijayan"],
      },
    ],
  },
  {
    ...
    subcoms: [
      {
        ...
        members: ["Alannah Darling", "Mridul Pant", "Tiana Vincent"],
      },
      {
        icons: [faBullhorn],
        name: "Marketing",
        ...
        members: ["Emily Ross", "Himanshu Singh", "Nala Hong", "Nicole Huang"],
      },
      {
        ...
        members: ["Annie Yan", "Hanyuan Li", "Rohan Agarwal"],
      },
      {
        icons: [faUserFriends],
        name: "Social",
        description: `The team is responsible for organising our social calendar, including planning, developing and executing a core suite of events. They ensure all members are given the opportunity to be a part of this vibrant community, through the creation and maintenance of social groups.`,
        members: ["Isabella Fang", "Jessica Degeling", "Palaash Rawat"],
      },
    ],
  },
  {
    ...
    subcoms: [
      ...
      },
      {
        ...
        name: "Charity",
        description: `The Charity portfolio seeks to create awareness, raise funds and drive social change for charities. The committee also compliments the Social portfolio in hosting fun events for a great cause.`,
        members: ["Alexandra Sheedy", "Crystal Zhao", "Thivakar Jeyaseelan"],
      },
      {
        icons: [faBullhorn],
        name: "Marketing",
        description: `The Marketing portfolio focuses on creating continued engagement with our Co-op Society Facebook platform. Via the creation of digital marketing content, all students are encouraged to participate in fulfilling social events.`,
        members: ["Anna Wu", "Arousha Soltany", "Jack Lane", "Savera Shabih"],
      },
      {
        icons: [faEdit, faDesktop],
        name: "Publications/IT",
      ...
      },
      {
        ...
        members: ["Isabella Cook", "Lily Miranda", "Zack Bolland"],
      },
    ],
  },
  {
