              ...
              <TabPane tabId="scholarsTab1">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <h5 className="card-title" >What’s the culture like at AMP?</h5>
                    <p className="description" style={{ color: 'black' }}>
              ...
              <TabPane tabId="scholarsTab2">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    </p><p className="description" style={{ color: 'black' }}>
                    ...
                    <h5 className="card-title" >How are some ways you balance work, university and your social life?</h5>
                    <p className="description" style={{ color: 'black' }}>
                    ...
                    <h5 className="card-title" > In what ways have you seen yourself develop personally as well as technically?</h5>
                    <p className="description" style={{ color: 'black' }}>
              ...
              <TabPane tabId="scholarsTab3">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <h5 className="card-title" >Where would you like to go for your next placement?</h5>
                    <p className="description" style={{ color: 'black' }}>
                    ...
                    <br></br>
                    <h5 className="card-title" >What’s the culture like at American Express?</h5>
                    <p className="description" style={{ color: 'black' }}>
              ...
              <TabPane tabId="scholarsTab4">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <h5 className="card-title" >What’s the culture like at PWC?</h5>
                    <p className="description" style={{ color: 'black' }}>
